 ...
 // all the good stuffs redacted... 
 let token_secret = "<redacted>";
 let adminUname = "<redacted>"
 let adminPWD = "<redacted>"
 let challenge_flag = "<redacted>"
  ...
  * Server Activation
  */
 app.listen(port, () => { console.log(`Listening to requests on http://0.0.0.0:${port}`); });
